...
export default function Header() {
  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-30 border-b border-qa-line/50 bg-qa-base/70 backdrop-blur-md">
      ...
      {menuOpen && (
        <div
          id="mobile-menu"
          className="border-t border-qa-line/50 bg-qa-base/95 backdrop-blur-md md:hidden"
        >
