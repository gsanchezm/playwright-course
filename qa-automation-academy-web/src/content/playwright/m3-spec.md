...
Esta página cubre la parte de **ejecución y lectura del ejemplo** de M03: correr los specs limpios que ya usan los Page Objects y comparar el antes/después contra M02. Al final tienes el código completo de `ejemplo.spec.ts`.
...
Abre M02 y M03 simultáneamente y responde:
...
```ts
// @file modulo-03-pom/ejemplo.spec.ts
// ============================================================
