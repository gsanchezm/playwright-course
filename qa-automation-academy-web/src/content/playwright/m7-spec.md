...
Esta página cubre la parte de **lectura y ejecución del ejemplo** de M07: las clases de la capa de servicios, correr la suite API, leer el flujo `auth → list pizzas by market` y comparar API vs UI. Al final tienes el código completo de `ejemplo.spec.ts`.
...
```ts
// @file modulo-07-api-layer/ejemplo.spec.ts
// ============================================================
