...
Estas dos líneas cubren los dos riesgos reales que ya tienes hoy: `node_modules/` (peso) y `.env` (secretos). Lo demás (`test-results/`, `playwright-report/`, `.auth/`) todavía **no existe** en tu carpeta — esas carpetas nacen en M01/M06, y allí el installer + tú las cubrirán.
