...
//
// Set completo heredado de M05 (checkoutPage/menuPage/profilePage/
// pizzaCustomizer incluidos). Lo nuevo de M06 no es OTRO fixture —
// es que `auth.setup.ts` y el project `chromium` (storageState)
// rodean a estos mismos fixtures: los tests ya no hacen login por UI.
// ============================================================
