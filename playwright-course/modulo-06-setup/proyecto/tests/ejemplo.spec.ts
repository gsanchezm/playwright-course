...
// ============================================================
// 🧩 Interactuando con los widgets nuevos de OmniPizza (heredado de M05)
// ============================================================
// Antes vivían en tests/interacciones-nuevas.spec.ts — ahora están aquí
// para tener TODO el módulo en un solo archivo.
//
...
// la mayoría de los tests NO hacen login — navegan directo, como el
// describe de arriba.
//
// Las excepciones son los tests de Arabia Saudita y de confirmación de
// orden: dependen del market elegido AL LOGIN (no de los datos que
// llenes después), y la sesión heredada quedó autenticada en MX (el
// `defaultMarket` de auth.setup.ts). Esos describes RENUNCIAN al badge
// con `test.use({ storageState: { cookies: [], origins: [] } })` — el
// mismo patrón que usa el reto de locked_out_user — y hacen su propio
// login.
// ============================================================
...
// ============================================================
test.describe("Native date picker on the profile (M06)", () => {
...
test.describe("Checkout widgets — item already in cart (M06)", () => {
  // Precondición compartida: agregar una pizza + abrir el checkout ya
  // poblado. A diferencia de M05, no hay login aquí — la sesión ya llega
  // autenticada por storageState. Antes vivía en la función
  // `openCheckoutWithItem(page, catalogPage, checkoutPage)`, llamada a
  // mano en cada uno de los 4 tests de abajo.
  ...
  // ============================================================
  test.describe("Credit card dropdowns (M06)", () => {
  ...
  // ============================================================
  test.describe("Payment method (radio group) (M06)", () => {
  ...
  // ============================================================
  test.describe("Custom tooltip on the tip (M06)", () => {
  ...
  // ============================================================
  test.describe("Native tooltip on the phone (M06)", () => {
...
// ============================================================
test.describe("Saudi Arabia market / RTL (M06)", () => {
...
// ============================================================
test.describe("Order confirmation popups (M06)", () => {
  test.use({ storageState: { cookies: [], origins: [] } });
