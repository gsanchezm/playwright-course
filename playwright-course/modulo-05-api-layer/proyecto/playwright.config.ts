// playwright.config.ts — Estado en M05 (enfoque API)
// ---------------------------------------------------------------------
// M05 introduce la capa de servicios (services/) para probar la API SIN
...
//
// (En el mono-repo del curso conviven además los projects UI de M04;
