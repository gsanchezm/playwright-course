...
// ============================================================
// Este spec es EL MISMO de M06 (Setup & auth), traído sin cambios:
// corre en el project `chromium`, que declara `dependencies: ['setup']`
...
// ============================================================
// 🧩 Interactuando con los widgets nuevos (heredado de M05/M06)
// ============================================================
// Antes vivían en tests/ui/interacciones-nuevas.spec.ts — ahora están
// aquí para tener TODA la capa UI en un solo archivo.
//
// Mismos 8 escenarios de M05/M06 (date picker, dropdowns, payment method,
// tooltips, modal, RTL, popups de confirmación). Sigue siendo la capa UI
// heredada — vive junto a la nueva capa de API (services/), sin cambios
// respecto a M06: corre en `chromium`, que hereda sesión vía
// storageState, así que la mayoría de los tests NO hacen login.
//
...
// patrón que ui/reto.spec.ts intenta con `storageState: undefined` — y hace
// su propio login como SA. El popup de confirmación de orden usa el mismo
// truco: el checkout de MX exige un campo `colonia` que `fillWithMarket()`
// no llena, así que ese describe también renuncia al badge y hace login
// como US.
// ============================================================

// Helper de setup: agrega una pizza + abre el checkout ya poblado (el
// checkout vacío muestra `start-order-btn`, no el form). No hay paso de
// login aquí: el `page` ya llega autenticado.
...
// ============================================================
test.describe("Native date picker on the profile", () => {
...
// ============================================================
test.describe("Credit card dropdowns", () => {
...
// ============================================================
test.describe("Payment method (radio group)", () => {
...
// ============================================================
test.describe("Custom tooltip on the tip", () => {
...
// ============================================================
test.describe("Native tooltip on the phone", () => {
...
// ============================================================
test.describe("Modal 'Customize Pizza'", () => {
...
// renuncia al badge y hace su propio login como SA.
// ============================================================
test.describe("Saudi Arabia market / RTL", () => {
...
// ============================================================
test.describe("Order confirmation popups", () => {
  test.use({ storageState: { cookies: [], origins: [] } });
