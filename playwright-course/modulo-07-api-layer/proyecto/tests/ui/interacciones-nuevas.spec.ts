// ============================================================
// M06 → M07 — Interactuando con los widgets nuevos (heredado de M05/M06)
// ============================================================
// Mismos 8 escenarios de M05/M06 (date picker, dropdowns, payment method,
// tooltips, modal, RTL, popups de confirmación). Este spec es la capa UI
// heredada — sigue viva junto a la nueva capa de API (services/), sin
// cambios respecto a M06: corre en `chromium`, que hereda sesión vía
...
// patrón que reto.spec.ts intenta con `storageState: undefined` — y hace
...
//   pnpm exec playwright test tests/ui/interacciones-nuevas.spec.ts --headed --project=chromium
// ============================================================
...
// ============================================================
test.describe("Date picker nativo del perfil", () => {
...
// ============================================================
test.describe("Dropdowns de la tarjeta de crédito", () => {
...
// ============================================================
test.describe("Método de pago (radio group)", () => {
...
// ============================================================
test.describe("Tooltip custom de la propina", () => {
...
// ============================================================
test.describe("Tooltip nativo del teléfono", () => {
...
// ============================================================
test.describe("Mercado Arabia Saudita / RTL", () => {
...
// ============================================================
test.describe("Popups de confirmación de orden", () => {
  test.use({ storageState: { cookies: [], origins: [] } });
