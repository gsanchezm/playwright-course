// ============================================================
// Setup & auth (heredado de M06): inicia sesión UNA vez, guarda el "badge"
// ============================================================
...
// guarda la sesión completa en un archivo. Sigue vigente en M07:
// la capa de API (`services/`) autentica DISTINTO (AuthService),
// así que este badge solo lo usan los tests de `tests/ui/`.
// ============================================================
