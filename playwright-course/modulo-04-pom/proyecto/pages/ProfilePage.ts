...
//
// Convención de testids (verificados 2026-07-12): todos se resuelven con
// tid(). fullname/address/save-btn llevan sufijo -desktop/-responsive;
// phone, birthday y notes no, pero tid() cae al testid base sin sufijo.
// ============================================================
