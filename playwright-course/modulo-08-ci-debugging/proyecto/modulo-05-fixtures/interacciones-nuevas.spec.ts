// ============================================================
// M05 — Interactuando con los widgets nuevos de OmniPizza (M08 — estado FINAL)
// ============================================================
...
// modulo-05-fixtures/ejemplo.spec.ts.
//
...
//   pnpm exec playwright test modulo-05-fixtures/interacciones-nuevas.spec.ts --headed --project=ui-chromium
// ============================================================
...
// ============================================================
test.describe("Date picker nativo del perfil (M08)", () => {
...
// ============================================================
test.describe("Dropdowns de la tarjeta de crédito (M08)", () => {
...
// ============================================================
test.describe("Método de pago (radio group) (M08)", () => {
...
// ============================================================
test.describe("Tooltip custom de la propina (M08)", () => {
...
// ============================================================
test.describe("Tooltip nativo del teléfono (M08)", () => {
...
// ============================================================
test.describe("Mercado Arabia Saudita / RTL (M08)", () => {
...
// ============================================================
test.describe("Popups de confirmación de orden (M08)", () => {
  test.use({ storageState: { cookies: [], origins: [] } });
